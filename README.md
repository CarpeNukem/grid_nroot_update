...
Upload `bin/Release/dist/GridNrootUpdate-0.10.1.zip` to a GitHub release named `plugin-v0.10.1`, then bump the Grid entry in the n_root feed to match. That feed is what users add in Dalamud:
